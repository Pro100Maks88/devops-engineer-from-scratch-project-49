...
## :bookmark: Правила игры
  ...
  Суть игры в следующем: пользователю показывается случайное число. И ему нужно ответить yes, если число простое, или no, если оно составное.
   ### 5. **Brain-Progression**
  Суть игры в следующем: пользователю показывается ряд чисел, который образует арифметическую прогрессию с одним пропущенным числом, пользователь должен определить и ввести пропущенное число. Пример: `5 7 9 11 13 .. 17 19 21` → ответ `15`
